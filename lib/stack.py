"""
    ...
    É uma estrutura de dados linear na qual tanto a
    operação de inserção (tradicionalmente chamada
    "push"), quando a operação de remoção ("pop")
    acontecem no final (ou topo). Em consequência,
    o funcionamento da pilha obedece ao princípio
    LIFO (Last In First Out): o último elemento a
    entrar deve ser o primeiro sair. 
"""
class Stack: 
